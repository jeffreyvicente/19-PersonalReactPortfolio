...
// Import project images from the images folder
            ...
            <div className="col text-center d-flex">
              ...
              <div className="card flex-fill" style={{width: '30rem'}}>
                ...
                <div className="card-body">
                  ...
                  <a href="https://github.com/jeffreyvicente/19-TextScribe" className="btn btn-primary m-3">Github Repo</a>
                  <a href="https://textscribe-a44a925d489a.herokuapp.com/" className="btn btn-primary m-3">Project Demo</a>
                </div>
              </div>
            ...
            <div className="col text-center d-flex">
              ...
              <div className="card flex-fill" style={{width: '30rem'}}>
                  ...
                  <div className="card-body">
                    ...
                    <a href="https://github.com/jeffreyvicente/10-SVGLogoMaker" className="btn btn-primary m-3">Github Repo</a>
                    <a href="https://drive.google.com/file/d/1SMqJPa__R6CxKcBt9iLQQAAdYiRSFhGb/view" className="btn btn-primary m-3">Project Demo</a>
                  </div>
                </div>
            ...
            <div className="col text-center d-flex">
              ...
              <div className="card flex-fill" style={{width: '30rem'}}>
                  ...
                  <div className="card-body">
                    ...
                    <a href="https://github.com/jeffreyvicente/06-WeatherHub" className="btn btn-primary m-3">Github Repo</a>
                    <a href="https://jeffreyvicente.github.io/06-WeatherHub/" className="btn btn-primary m-3">Project Demo</a>
                 </div>
              </div>
            ...
            <div className="col text-center d-flex">
              ...
              <div className="card flex-fill" style={{width: '30rem'}}>
                ...
                <div className="card-body">
                  ...
                  <a href="https://github.com/jeffreyvicente/05-TaskMaster" className="btn btn-primary m-3">Github Repo</a>
                  <a href="https://jeffreyvicente.github.io/05-TaskMaster/" className="btn btn-primary m-3">Project Demo</a>
                </div>
              </div>
            ...
            <div className="col text-center d-flex">
              ...
              <div className="card flex-fill" style={{width: '30rem'}}>
                  ...
                  <div className="card-body">
                    ...
                    <a href="https://github.com/jeffreyvicente/04-brain-battle" className="btn btn-primary m-3">Github Repo</a>
                    <a href="https://jeffreyvicente.github.io/04-brain-battle/" className="btn btn-primary m-3">Project Demo</a>
                  </div>
                </div>
            ...
            <div className="col text-center d-flex">
              ...
              <div className="card flex-fill" style={{width: '30rem'}}>
                  ...
                  <div className="card-body">
                    ...
                    <a href="https://github.com/jeffreyvicente/food-roulette" className="btn btn-primary m-3">Github Repo</a>
                    <a href="https://jeffreyvicente.github.io/food-roulette/" className="btn btn-primary m-3">Project Demo</a>
                 </div>
              </div>
